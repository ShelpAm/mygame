...
public:
    ...
    bool team_near_position(EntityManager& entities, Team team,
                          Vec2f pos, float radius) const;

    // Spawn a wave of enemies
    void spawn_enemy_wave(EntityManager& entities, int count,
...
private:
    ...
    EntityId find_nearest_enemy(EntityManager& entities,
